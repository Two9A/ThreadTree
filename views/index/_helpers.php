    ...
    <div class="tweet" id="tweet-<?= $tweet_id ?>">
     <div class="tweet-head">
      ...
      <span class="tweet-author">
       ...
       <a href="https://mastodon.world/@<?= $data['username'] ?>" class="tweet-author-username">@<?= $data['username'] ?></a>
       <a href="https://mastodon.world/@<?= $data['username'] ?>/<?= $tweet_id ?>" class="tweet-link"><?= $data['created_at'] ?></a>
      </span>
     </div>
     <?php if ($count) { ?>
     <div class="tweet-count"><?= $count,' ' ?> toots</div>
     <?php } ?>
